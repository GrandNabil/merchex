...
urlpatterns = [
    ...
    path('bands/', views.band_list, name='band-list'), # nouveau path poour vue listée
    path('bands/<int:id>/', views.band_detail, name='band-detail'), # modèle url pour vue détaillé
    ...
    path('email-sent', views.contact, name='email-sent')
]
